...
\begin{tabular}{ |p{5cm}|p{9cm}|}
  ...
  \hline
  R1 & ENS2: 172.16.0.1 \par ENS3: 10.0.1.3 \\
  \hline
  R2 & ENS2: 10.0.2.2 \par ENS3: 10.0.2.3 \par ENS4: 10.0.2.4 \\
  \hline
  R3 & ENS2: 10.0.3.2 \par ENS3: 10.0.3.3 \par ENS4: 10.0.3.4 \\
  \hline
  R4 & ENS2: 10.0.4.2 \par ENS3: 10.0.4.3 \par ENS4: 10.0.4.4 \\
  \hline
  R5 & ENS2: 10.0.5.2 \par ENS3: 192.168.1.1 \\
  \hline
