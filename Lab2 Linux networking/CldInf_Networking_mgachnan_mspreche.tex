...
\end{shadedquotation}
  ...
  \begin{figure}[H]
  	...
  	\end{center}
  Mit einer Packetlossrate von 10\% bricht die Leistung vom Netzerk wie erwartet extrem ein und wird fast unbrauchbar. Die Bandbreite sinkt durch die verlorenen Packete von 2.6 Gbits/sec auf ca 12 MBits/sec ein.
  \end{figure}
  \begin{figure}[H]
  	\begin{center}
...
https://man7.org/linux/man-pages/man8/tc-netem.8.html - Kapitel 4 Leistung
https://sandilands.info/sgordon/dropping-packets-in-ubuntu-linux-using-tc-and-iptables - Kapitel 4 Leistung
https://iperf.fr/iperf-doc.php - Kapitel 4 Leistung
