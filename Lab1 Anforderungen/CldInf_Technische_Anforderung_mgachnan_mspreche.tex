...
\begin{landscape}
  ...
  \begin{tabular}{ |p{2cm}|p{5cm}|p{5cm}|p{5cm}|p{5cm}|  }
    ...
    &
    Eine Änderung am Netzwerk sollte ohne Probleme gehen: Komponenten hinzufügen und entfernen.
    &
    ...
    &
    Die angeforderte Leistung sollte stets verfügbar sein.
    &
    ...
    &
    Der Verbrauch und frei Platz des Storages sollte ersichtlich sein.
    \\
    \hline
  \end{tabular}
\end{landscape}
